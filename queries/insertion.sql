...
-- Inserción de tabla cientes
insert into clientes (numeroCliente, mombreCliente, contactoNombre,contactoApellido,telefono,direccionLine1,direccionLine2,ciudad,estado,codigoPostal,pais,vendedorRepNumero,limiteCredito) values 
...
-- inserción tabla oficinas

insert  into oficinas(codigoOficina, ciudad,telefono,direccionLine1,direccionLine2,estado,pais,codigoPostal,territorio) values 
...
insert  into empleados(numeroEmpleado, apellido, nombre, extension, email, codigoOficina, reportaA, tituloTrabajo) values 
...
-- Inserción tabla  lineaProductos
insert  into lineaProductos(lineaProducto, descripcionTexto, descriptionHTML, imagen) values 
...
insert  into productos(codigoProducto, nombreProduct, lineaProducto, scalaProducto, proveedorProducto, descripcionProducto, cantidadStock, precioCompra, MSRP) values 
...
-- Inserción tabla detallecompra
insert  into detallecompra(numeroOrden, codigoProducto, cantidadOrdenada, precio, numeroLinea, numeroVendedor) values 
...
-- Inserción tabla productos
insert  into productos(codigoProducto, nombreProduct,lineaProducto, escalaProducto,proveedorProducto,descripcionProducto, cantidadStock, precioCompra,MSRP) values 
