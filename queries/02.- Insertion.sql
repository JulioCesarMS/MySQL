...
# inserción con importación wizart (se anexa .csv)
...
-- Inserción tabla oden
insert  into `orden`(`numeroOrden`,`fechaOrden`,`fechaRequerida`,`fechaEmbarque`,`estatus`,`comentarios`,`numeroCliente`) values 
